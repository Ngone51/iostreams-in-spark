 ...
 *
 * NOTE: we always use this when we want to read data from a certain partition. A partition's
 * data size is fixed, so it's suitable to read data by LimitedInputStream. Also, it can avoid
 * data mix up, especially for partition data.
 */
